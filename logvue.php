                ...
                <div class="punishmentsAndBans">
                    ...
                    <div v-for="b in reports.added.bans">
                        <div class='punishment_report logger'>
                            <span class='player'>{{b.player}}'s Ban Report</span>
    ...
    <div class="modal" id="addBan">
        ...
        <div class="content" style="max-width: 400px;padding:0;">
            ...
            <div class="field">
                ...
                <input v-model="reports.ban.length" class="fieldInput" id="bl" type="text" placeholder="Ban Length (Days) (0 for perm)*"></div>
            <div class="field">
                <div class="fieldTitle">Ban Message</div>
                <input v-model="reports.ban.message" class="fieldInput" id="bm" type="text" placeholder="Ban Message*"></div>
            <div class="field">
